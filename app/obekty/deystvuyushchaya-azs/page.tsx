...
const faqs = [
  {
    ...
    a: "Нет, если это не предусмотрено технико-эксплуатационной документацией станции: п. 385 «б» Правил противопожарного режима запрещает проезд транспорта над подземными резервуарами. КРАН-СПБ ставит опоры вне резервуарного парка и сверяет точку установки со схемой станции.",
  },
  {
    q: "Нужно ли полностью закрывать АЗС для замены навеса?",
    a: "Не всегда. Если навес меняют частями, КРАН-СПБ работает при закрытых островках под траекторией груза, а остальная станция принимает машины. Полное закрытие нужно, когда груз проходит над всей зоной заправки или кран стоит на въезде.",
  },
  {
    q: "Можно ли работать краном во время слива топлива из автоцистерны?",
    a: "КРАН-СПБ не планирует подъём на время приёма топлива: по п. 381 Правил противопожарного режима при наполнении резервуаров из автоцистерны без донного клапана посторонним на территории находиться нельзя. График слива согласуется с оператором станции заранее.",
  },
  {
    q: "Какой кран нужен для замены топливораздаточной колонки?",
    a: "Колонку обычно поднимают с коротким вылетом, поэтому КРАН-СПБ чаще предлагает SANY STC400T класса 25–40 т. Точный класс определяет масса колонки по паспорту и расстояние от точки установки до островка.",
  },
  {
    q: "Кто отвечает за огневые работы при реконструкции АЗС?",
    a: "Огневые работы и работы внутри резервуаров ведёт подрядчик станции по своим допускам. КРАН-СПБ отвечает за подъём и перемещение груза краном с экипажем по ППР, который готовит заказчик или его подрядчик.",
  },
];
    ...
    <main>
      ...
      <section className="section wrap section--open">
        <div className="section-head">
          ...
          <p>
            ...
            резервуарами, если его не допускает документация станции. Поэтому КРАН-СПБ сначала
      ...
      <section className="section wrap prose section--flush measure">
        ...
        <p>
          ...
          поэтому КРАН-СПБ не ставит его над резервуарным парком без прямого разрешения в этой
        ...
        <p>
          ...
          Из-за этого вылет растёт, и КРАН-СПБ иногда предлагает кран на класс выше, чем подсказывает
        ...
        <p>
          Владелец АЗС выбирает между тремя сценариями, и КРАН-СПБ считает под каждый своё число
        ...
        <p>
          Приём топлива КРАН-СПБ в окно работы не ставит: по п. 381 Правил противопожарного режима
        ...
        <p>
          Класс крана на АЗС КРАН-СПБ выбирает по вылету от разрешённой точки установки. SANY STC400T
          ...
          и тянется через зону заправки к навесу. Кран класса 81–130 т на городской АЗС КРАН-СПБ
          предлагает редко: на площадке обычно негде разложить его опоры.
        </p>

        <h2 id="stoimost">Сколько стоит работа на АЗС</h2>
        <p>
          Наценки за работу на действующей АЗС у КРАН-СПБ нет, ставка зависит только от класса.
        ...
        <p>
          Для сети АЗС КРАН-СПБ заключает рамочный договор аренды техники с экипажем и подаёт кран
