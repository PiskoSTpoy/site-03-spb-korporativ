  ...
  return (
    <main>
      ...
      <section className="section wrap prose section--flush measure">
        ...
        <p>
          Именно этот класс чаще всего закрывает рядовые адреса{" "}
          <Link href="/geo/tsentralnyy/">Центрального района</Link> — не только памятники, но и обычную
          застройку без охранного статуса вплотную к ним.
        </p>
      </section>
