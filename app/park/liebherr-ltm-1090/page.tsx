  ...
  return (
    <main>
      ...
      <section className="section wrap prose section--flush measure">
        ...
        <p>
          В заявках эта машина чаще всего связана с двумя точками на карте сети: неподготовленным
          подъездом промышленной площадки Ижорских заводов
          в <Link href="/geo/kolpinskiy/">Колпинском районе</Link> и доковой разгрузкой складского
          комплекса «Шафировский» в <Link href="/geo/krasnogvardeyskiy/">Красногвардейском районе</Link> —
          в обоих случаях подъезд решает раньше веса.
        </p>
        <p>
