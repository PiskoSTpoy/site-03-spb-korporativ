          ...
          <div className="nav__row wrap">
            ...
            */}
            ...
            {/*
              ...
              номером телефона внутри nav__links — визуально такая же ссылка, как
              «Объекты» или «Парк техники», без выделения. Мобильная CTA-панель
              ниже (mcta__btn--primary, тот же якорь /#kp) даёт явную сплошную
              кнопку, а посетитель с широким экраном такого сигнала не видел
              вовсе. Кнопка вне SiteNav — компонент общий с мобильным меню, а
              этот CTA на мобильной раскладке не нужен (там уже есть mcta).
            */}
            <a className="nav__order-btn" href="/#kp">Запросить КП</a>
          </div>
        </header>
