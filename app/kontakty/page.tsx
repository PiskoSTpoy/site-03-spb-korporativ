...
const title = "Контакты — KRANNEVA, аренда автокрана в Петербурге";
const description =
    ...
    <main>
      ...
      <section className="section wrap prose section--open measure">
        ...
        <p>
          ...
          договора с приложениями. Если вопрос организационный — пропуск, разводка мостов, допуск
          на терминал или охранный статус площадки, — короткие ответы уже собраны на
          странице <Link href="/faq/">«Вопросы»</Link>.
        </p>
